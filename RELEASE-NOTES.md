...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([superpowers-skills](https://github.com/Nils-Lopez/superpowers-skills)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [superpowers-skills](https://github.com/Nils-Lopez/superpowers-skills).
...
3. Fresh clone of superpowers-skills will be created at `~/.config/superpowers/skills/`
...
- Clones superpowers-skills on first run
...
**Removed:**
- `skills/` directory (82 files) - Now in superpowers-skills
- `scripts/` directory - Now in superpowers-skills/skills/using-skills/
...
```bash
git clone https://github.com/Nils-Lopez/superpowers.git ~/.config/superpowers/plugin
cd ~/.config/superpowers/plugin
git pull
```

This fork installs directly from the repository (no marketplace dependency).
...
- Skills repository is now at https://github.com/Nils-Lopez/superpowers-skills
...
**Full Changelog:** https://github.com/Nils-Lopez/superpowers/compare/dd013f6...main
**Skills Repository:** https://github.com/Nils-Lopez/superpowers-skills
