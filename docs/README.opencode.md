...
```
Clone https://github.com/Nils-Lopez/superpowers to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugin, then symlink ~/.config/opencode/superpowers/.opencode/plugin/superpowers.js to ~/.config/opencode/plugin/superpowers.js, then restart opencode.
```
...
git clone https://github.com/Nils-Lopez/superpowers.git ~/.config/opencode/superpowers
```
